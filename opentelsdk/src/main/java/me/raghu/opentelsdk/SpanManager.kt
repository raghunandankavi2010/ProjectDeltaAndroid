...
//object SpanManager {
//    private val spanMap: MutableMap<String, Span> = mutableMapOf()
//    private val childSpanMap: MutableMap<String, MutableList<String>> = mutableMapOf()
//
//    fun startSpan(tracer: Tracer, spanName: String, parentSpan: Span? = null): Span {
//        return spanMap[spanName] ?: run {
//            val spanBuilder = tracer.spanBuilder(spanName)
...
//
//    fun endSpan(spanName: String) {
//        val childSpans = childSpanMap[spanName] ?: mutableListOf()
//        childSpans.forEach { childSpanName ->
//            spanMap[childSpanName]?.end()
//            spanMap.remove(childSpanName)
//        }
//        spanMap[spanName]?.end()
//        spanMap.remove(spanName)
//        childSpanMap.remove(spanName)
//    }
//
//    fun createChildSpan(tracer: Tracer, parentSpanName: String, childSpanName: String): Span? {
//        val parentSpan = getSpan(parentSpanName)
//        return if (parentSpan != null) {
//            val childSpan = startSpan(tracer, childSpanName, parentSpan)
//            childSpanMap.computeIfAbsent(parentSpanName) { mutableListOf() }.add(childSpanName)
//            childSpan
//        } else {
//            null
//        }
